...
- **Development Environment**: Modularized LSPs and development tools into a new `devel.nix` file. This centralizes language support (Nix, Rust, Python, Go, Java, Bash, etc.) for Helix, NixVim, and other editors while keeping `home.nix` clean.
